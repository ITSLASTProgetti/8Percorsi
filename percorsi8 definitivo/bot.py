...
async def Info(update: Update, context: ContextTypes.DEFAULT_TYPE)->None:
        await update.message.reply_text("SEGUI ATTENTAMENTE QUESTA STRUTTURA: /Query Nomezona(metti la iniziale maiuscola) lunghezza_del_percorso_voluto; Esempio: /Query Sommacamapagna 9")
        await update.message.reply_text("In caso non trovasse nulla , prova scrivendo un'altra lunghezza aumentando o diminuendo di 1")
def main():
